...
def generate_launch_description():
    ...
    robot_desc_pkg = get_package_share_directory('gripperbot')

    moveit_config = (
        MoveItConfigsBuilder("robot", package_name="gripperbot")
    ...
    rviz_config_path = os.path.join(get_package_share_directory('gripperbot'), "config", "gripperbot.rviz")
    rviz_node = Node(
          package="rviz2",
          executable="rviz2",
          name="rviz2",
